...
### Spring
 - 학교 수업 중 사용함. / 게시판 제작하면서 사용 MVC 모델 사용하여 제작 / 소규모 프로젝트 / (주)이지스에서 사용하여 개발
 
### mySql
 - 학교 수업 중 사용함. / 서버를 활용 하기 위해 mySql을 사용하여 제작 하였음. / (주)이지스에서 사용하여 개발
 - 
### Java
 - 학교 수업 중 사용함. / (주)이지스에서 사용하여 개발 / Swing 활용 GUI 학생관리시스템 제작 / 소규모 

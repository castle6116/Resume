...
### JavaScript, JQuery
 - 학교 수업 중 사용함, 현장 실습에서 사용 / GIS 기반 사내 Api 사용 및 OpenLayers 등으로 활용 / 소규모 프로젝트 , (주)이지스에서 사용하여 개발

### Spring
 - 게시판 제작하면서 사용 MVC 모델 사용하여 제작 / 소규모 프로젝트 / (주)이지스에서 사용하여 개발
 
### mySql
 - 서버를 활용 하기 위해 mySql을 사용하여 DB를 구축 하였음. / (주)이지스에서 사용하여 개발
 - 
### Java
...
- - - - -
### Php
 - 학교 수업 중 서버 언어로 사용함. / Tomcat을 활용한 로컬 서버 통신 게시판 제작 / 소규모 

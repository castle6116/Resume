...
+ 2021.7.5 ~ 2021.12.10 (주)이지스 iOS 어플(웹뷰) , 웹 유지보수 업무 진행
...
### JavaScript, JQuery
 - GIS 활용, 사내 Api 제작 및 활용, OpenLayers 등으로 활용 / (주)이지스에서 사용하여 개발

### Spring
 - 게시판 제작하면서 사용 MVC 모델 사용하여 제작 / 소규모 프로젝트 / (주)이지스에서 사용하여 개발

### mySql
 - 백앤드를 활용 하기 위해 mySql을 사용하여 DB를 구축 하였음. / (주)이지스에서 사용하여 개발

### Java
 - Swing 활용 GUI 학생관리시스템 제작

- - - - -
미숙한 언어
- - - - -
### Php
 - 학교 수업 중 서버 언어로 사용함. / Tomcat을 활용한 로컬 서버 통신 게시판 제작
